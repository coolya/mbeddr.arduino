...
<solution name="mbeddr.arduino.__spreferences.TypeSizeConfiguration" uuid="~_PreferencesModule#mbeddr.arduino.__spreferences.TypeSizeConfiguration" compileInMPS="true">
  <models>
