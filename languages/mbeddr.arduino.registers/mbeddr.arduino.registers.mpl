...
<language namespace="mbeddr.arduino.registers" uuid="3828799d-97c8-48d0-af8b-39b903457e1e" version="0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator generatorUID="mbeddr.arduino.registers#5152824560130938155" uuid="5fedd8d1-a723-4001-ab7b-30cda79fe730">
      <models>
        <modelRoot contentPath="${module}" type="default">
