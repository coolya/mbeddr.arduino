...
<model modelUID="r:3c7790ca-a687-4dfa-a94e-7b5e9848d78c(mbeddr.arduino.core.structure)" version="3">
  ...
  <roots>
    ...
    <node type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="5466295800791659568">
      <property name="name" nameId="tpck.1169194664001" value="ArduinoDiscription" />
